...
public class telaChecout extends javax.swing.JFrame {
    ...
    public void pesquisarHospedagem(String data) throws ParseException, SQLException{
        ...
        if(hosp.getId() == 0)
            ...
            try{
                ...
                Double valor = preco * dias;
                lValorEstadia.setText("Valor Estadia: " + valor);
    ...
    public void valorFinal() throws SQLException{
        ...
        valor += adicionais + valorFrigobar;        
        lValorTotal.setText("Valor Total: R$ " + valor);
        lValorTotal.setBackground(Color.red);
    }
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ldefinirData)
                    .addComponent(bPesquisar2)
                    .addComponent(ftDefinirData, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE))
                .addContainerGap())
        );
